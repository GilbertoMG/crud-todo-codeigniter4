...
<?= form_input([
		...
		'id' => 'nome',
		'placeholder' => 'Nome',
        'value' => $results->nome ??  set_value('nome'),
...
<?= form_dropdown('prioridade',[
    0 => '(Selecione)',
	1 => 'Baixa',
	2 => 'Alta',
	3 => 'Urgente',
	4 => 'Crítica',
],$results->prioridade ??  set_value('prioridade'),['id'=>'prioridade','class'=>'form-control form-control-sm']);?>
</div>
...
<?= form_textarea([
        'class'=>'form-control form-control-sm',
		'name'=>'detalhes',
		'placeholder'=>'Informe aqui detalhes da Tarefa',
        'id'=>'detalhes',
		//'required'=>'required',
		'rows'=>4,
		'value' => isset($results->detalhes) ? $results->detalhes :  set_value('detalhes')
		]);
?>
</div>
