...
<?php endif; ?>
                ...
                <?=
                form_input([
                    'class' => 'form-control form-control-sm required','placeholder' => 'Login',
                    'type' => 'text', 'name' => 'login',
					'required'=>'required',
                    'id' => 'login', 'value' => $results->login ?? set_value('login')]);
                ?>
                                        </div>
                                        <div class="form-group p-2">
                ...
                <?=
                form_input([
                    'class' => 'form-control form-control-sm border-none', 'placeholder' => 'Sua senha',
